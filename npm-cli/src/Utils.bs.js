...
function kebab(str) {
  ...
  var k = $$Array.map((function (c) {
              ...
              } else if (Char.uppercase_ascii(c$1) !== Char.lowercase_ascii(c$1) && Char.uppercase_ascii(c$1) === c$1) {
...
function renderAsciiTree(dir, name, namespace, $$require, isLast) {
  if (isLast) {
    return Curry._3(Printf.sprintf(/* Format */Caml_chrome_debugger.simpleVariant("Format", [
