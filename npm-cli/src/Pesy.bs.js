...
function downloadTemplate(template) {
  var spinner = Spinner$PesyBootstrapper.start(
    "\x1b[2mDownloading template\x1b[0m " + template
  );
  DownloadGitRepo(template, projectPath, function(error) {
    ...
    if (error !== undefined) {
      ...
      var setup_files_spinner = Spinner$PesyBootstrapper.start(
        "\x1b[2mSetting up template\x1b[0m " + template
      );
      try {
        var files = Belt_Array.keep(WalkSync(projectPath), function(
          file_or_dir
        ) {
          return Fs.statSync(file_or_dir).isFile();
        });
        Belt_Array.forEach(files, function(file) {
          Utils$PesyBootstrapper.write(
            file,
            substituteTemplateValues(Utils$PesyBootstrapper.readFile(file))
          );
          Fs.renameSync(
            file,
        ...
        if (exn[0] === Js_exn.$$Error) {
          ...
          if (match !== undefined) {
            ...
            console.log(
              "\x1b[31mPesy encountered an unknown error as it was trying to setup templates\x1b[0m"
            );
          }
          Pervasives.exit(-1);
        } else {
      ...
      var id = Spinner$PesyBootstrapper.start(
      ...
      Child_process.exec("esy i", function(e, stdout, stderr) {
        ...
        if (Caml_obj.caml_equal_nullable(e, null)) {
          var id$1 = Spinner$PesyBootstrapper.start(
          ...
          Child_process.exec("esy pesy", function(e, stdout, stderr) {
            ...
            if (Caml_obj.caml_equal_nullable(e, null)) {
              var id$2 = Spinner$PesyBootstrapper.start(
              ...
              Child_process.exec("esy build", function(e, stdout, stderr) {
                ...
                if (Caml_obj.caml_equal_nullable(e, null)) {
                  ...
                  return Utils$PesyBootstrapper.write(
                    "pesy.stderr.log",
                    stderr
                  );
                }
...
var template = Cmdliner.Arg[/* & */ 9](
  Cmdliner.Arg[/* value */ 20],
  Cmdliner.Arg[/* & */ 9](function(param) {
    ...
    undefined,
    "TEMPLATE_URL",
    "Specify URL of the remote template. This can be of hthe form https://repo-url.git#<commit|branch|tag>. Eg: https://github.com/reason-native-web/morph-hello-world-pesy-template#6e5cbbb9f28",
    undefined,
    /* :: */ ["t", /* :: */ ["template", /* [] */ 0]]
  ))
);

var useDefaultOptions = Cmdliner.Arg[/* & */ 9](
  Cmdliner.Arg[/* value */ 20],
  Cmdliner.Arg[/* & */ 9](
    Cmdliner.Arg[/* flag */ 10],
    Cmdliner.Arg[/* info */ 8](
      undefined,
      undefined,
      "Use default options",
...
var cmdT = Cmdliner.Term[/* $ */ 3](
  Cmdliner.Term[/* $ */ 3](Cmdliner.Term[/* const */ 0](main), template),
  useDefaultOptions
);
...
var cmd = /* tuple */ [cmdT, cmd_001];

Cmdliner.Term[/* eval */ 16](
  undefined,
  undefined,
  undefined,
  undefined,
